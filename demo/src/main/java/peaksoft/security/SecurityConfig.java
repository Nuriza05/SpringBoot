...
public class SecurityConfig {
    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
         http.authorizeHttpRequests()
                 ...
                 .requestMatchers("/hospitals/{id}/mainPage").permitAll()
                 .requestMatchers("/hospitals/show").permitAll()
                 ...
                 .requestMatchers("/appointments/{hospitalId}/new").permitAll()
                 .requestMatchers("/appointments/{hospitalId}/savePage").permitAll()
                 .requestMatchers("/appointments/{hospitalId}/{appointmentId}/edit").permitAll()
                 .requestMatchers("/appointments/{hospitalId}/{appointmentId}/update").permitAll()
                 .requestMatchers("/appointments/{hospitalId}/{appointmentId}/delete").permitAll()
        .and()
        .formLogin()
